...
type RoughFilterIds = Readonly<{ rough: string; soft: string }>;
type DecorationProps = Readonly<{
  className?: string;
  filterIds: RoughFilterIds;
}>;

function RoughFilters({ filterIds }: Readonly<{ filterIds: RoughFilterIds }>) {
  return (
    <svg className="absolute h-0 w-0" aria-hidden="true" focusable="false">
      <defs>
        <filter id={filterIds.rough} x="-30%" y="-30%" width="160%" height="160%">
          <feTurbulence
            type="fractalNoise"
            baseFrequency={0.045}
            numOctaves={2}
        ...
        <filter id={filterIds.soft} x="-30%" y="-30%" width="160%" height="160%">
          <feTurbulence
            type="fractalNoise"
            baseFrequency={0.035}
            numOctaves={2}
...
function WavyDecoration({ className, filterIds }: DecorationProps) {
  return (
    <svg
      className={className}
      viewBox="0 0 140 14"
...
function CircleDecoration({ className, filterIds }: DecorationProps) {
  return (
    <svg
      className={className}
      viewBox="0 0 220 64"
...
function HighlightDecoration({ className, filterIds }: DecorationProps) {
  return (
    <svg
      className={className}
      viewBox="0 0 170 26"
...
function UnderlineDecoration({ className, filterIds }: DecorationProps) {
  return (
    <svg
      className={className}
      viewBox="0 0 140 10"
...
function CrossOutDecoration({ className, filterIds }: DecorationProps) {
  return (
    <svg
      className={className}
      viewBox="0 0 140 40"
...
function BracketDecoration({ className, filterIds }: DecorationProps) {
  return (
    <svg
      className={className}
      viewBox="0 0 160 60"
...
function BoxDecoration({ className, filterIds }: DecorationProps) {
  return (
    <svg
      className={className}
      viewBox="0 0 200 64"
...
export const AnnotatedText = forwardRef<HTMLSpanElement, AnnotatedTextProps>(
  ({ children, variant = "wavy", color, className }, ref) => {
    const id = useId();
    const filterIds = { rough: `${id}-rough`, soft: `${id}-rough-soft` };
    ...
    if (isBehindText) {
      return (
        <>
          <RoughFilters filterIds={filterIds} />
          <span ref={ref} className={cn(style.wrapper, className)}>
            <span className="relative z-10">
              {children}
            </span>
            <Decoration
              className={cn(decorationClass, "z-0")}
              filterIds={filterIds}
            />
          </span>
        </>
    ...
    return (
      <>
        ...
        <span ref={ref} className={cn(style.wrapper, className)}>
          {children}
          <Decoration className={decorationClass} filterIds={filterIds} />
        </span>
      </>
    );
  },
