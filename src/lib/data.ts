...
export const ventures: Venture[] = [
  {
    ...
    accent: "#8b5cf6",
    image: "/marketplay/decision.webp",
    gallery: [
      { src: "/marketplay/crash.webp", alt: "MarketPlay market crash with three simulated trading choices" },
      { src: "/marketplay/story.webp", alt: "MarketPlay story mode with a lesson path and starting checkpoint" },
      { src: "/marketplay/decision.webp", alt: "MarketPlay concert scenario with save, spend and pay-later choices" },
      { src: "/marketplay/player-card.webp", alt: "MarketPlay Street Smart player card and starting net worth" },
      { src: "/marketplay/learn.webp", alt: "MarketPlay Money Basics learning modules" },
      { src: "/marketplay/lesson.webp", alt: "MarketPlay inflation lesson explaining purchasing power" },
      { src: "/marketplay/result.webp", alt: "MarketPlay scenario result showing the impact of a money decision" },
      { src: "/marketplay/trade.webp", alt: "MarketPlay paper trading desk with simulated balance and orders" },
    ],
